...
import { Activity, Atom, Sparkles, ShieldCheck, Stethoscope } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <a
              href="../"
              className="bg-indigo-950/70 hover:bg-indigo-900/90 text-indigo-300 hover:text-indigo-100 border border-indigo-700/60 px-2.5 py-1.5 rounded-lg flex items-center space-x-1.5 transition-all shadow-sm"
              title="Return to Unified Oncology Suite Portal"
            >
              <span className="font-semibold text-indigo-200">⬡ Suite Portal</span>
            </a>
            <a
              href="../oncoscan.html"
              className="bg-slate-900/90 hover:bg-slate-800 text-slate-300 hover:text-white border border-slate-700/80 px-2.5 py-1.5 rounded-lg flex items-center space-x-1.5 transition-all shadow-sm"
              title="Launch OncoScan AI Genomic Platform"
            >
              <span>⇄ OncoScan AI</span>
            </a>
